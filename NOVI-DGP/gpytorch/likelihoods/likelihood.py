    ...
    def _draw_likelihood_samples(self, function_dist, *args, sample_shape=None, **kwargs):
        if sample_shape is None:
            sample_shape = torch.Size(
                [settings.num_likelihood_samples.value()]  # 10 for regression
        ...
        function_samples = function_dist.rsample(sample_shape)  # generate sample_shape samples from function_dist

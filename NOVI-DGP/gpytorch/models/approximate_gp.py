...
class ApproximateGP(GP, _PyroMixin):
    ...
    The :math:`forward` function should describe how to compute the prior latent distribution
    ...
    def __call__(self, inputs, prior=False, train_type=True, disc_type=True, hyp_type=True,
                 trace_layer_list=None, norm_layer_list=None, u_layer_list=None, fiu_layer_list=None,
                 glogpfu_layer_list=None, shared_list=None, transformed_list=None, **kwargs):
        if inputs.dim() == 1:
            inputs = inputs.unsqueeze(-1)
        return self.variational_strategy(inputs, prior=prior, train_type=train_type, disc_type=disc_type,
                                         ...
                                         shared_list=shared_list, transformed_list=transformed_list,
                                         **kwargs)

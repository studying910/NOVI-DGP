...
class Module(nn.Module):
    ...
    def __call__(self, *inputs, **kwargs):
        ...
        return _validate_module_outputs(outputs)  # validate the output type
...
def _validate_module_outputs(outputs):  # validate the output to match some predefined types
